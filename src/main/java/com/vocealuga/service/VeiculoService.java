...
public class VeiculoService {
    ...
    public void deleteVeiculo(Integer veiculoId) {
        ...
        List<Manutencao> manutencoesEmCurso = manutencaoRepository.findByVeiculoIdAndStatusNot(veiculoId, "Cancelada");
        if (!manutencoesEmCurso.isEmpty()) {
            throw new RuntimeException("Não pode remover, veículo está em manutenção.");
        }
